...
\section{The Standards Organizations}\index{standards}
...
telephony have been developed by the ITU\index{ITU}. However, one of the most significant
steps in standardisation of mobile wireless was the
development of the GSM standard \cite{GSM}\index{GSM}, which was undertaken primariy by the
European Telecommunications Standards Institute (ETSI) (See \S\ref{ETSI}\index{ETSI}).
For example, the original standard for SIM cards was developed as part of
this standard.



\subsection{Institute of Electrical and Electronic Engineers (IEEE)}\index{IEEE}
...
\subsection{Internet Engineering Task Force (Internet Standards)}\index{IETF}
...
\subsection{The International Telecommunication Union (ITU)}\index{ITU}\label{ITU}\index{ITU}
...
\subsection{The International Standards Organization (ISO)}\index{ISO}
...
\subsection{The 3rd-Generation Partnership Project (3GPP)}\index{3GPP}
...
The evolution of 3G (UMTS)\index{UMTS} to 4G (LTE)\index{LTE} to 
5G (NR)\index{NR} over the years has been
...
in the development of 5G\index{5G}. 5GPPP projects range from physical layer to
...
\section{The WiFi Standard}\index{Wifi!standard}
...
\subsection{What is regulated}\index{regulations}
...
\subsection{Evolution of the 802.11 standard}\index{802.11!history}
...
\section{Other Standards Relevant to Wifi}\index{Wifi!standards}
