...
\section{Wireless Chronology}\index{chronology}\index{history}
...
place into {\em cells}\index{cell}. The frequencies in use in one cell can then be re-used in a cell that
is not too close
...
In 1985, the idea that some wireless spectrum can be {\em unlicensed}\index{spectrum!unlicensed} was introduced.
...
\subsection{Shared spectrum}\index{spectrum!shared}
...
to 100 million cycles per second (100 MHz), we say it has a {\em bandwidth}\index{bandwidth} of
80 MHz.
